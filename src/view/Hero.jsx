...
const Hero = ({ onSearch, onSelect, sortAscending, sortDescending }) => {
  ...
  // const submitAscending = (e) => {
  //   e.preventDefault();
  //   onSearch(submit);
  // };

  // const submitDescending = (e) => {
  //   e.preventDefault();
  //   onSearch(submit);
  // };
  ...
  return (
    <section className="hero">
      <div className=" bg-white flex dark:bg-gray-900">
        <div className="grid text-center mx-auto flex xl:mt-20 max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
