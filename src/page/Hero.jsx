...
const Hero = ({ onSearch, onSelect }) => {
  ...
  return (
    <section className=" bg-white items-center text-center mx-auto justify-center flex dark:bg-gray-900">
      <div className="grid items-center text-center mx-auto justify-center flex xl:mt-20 max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
